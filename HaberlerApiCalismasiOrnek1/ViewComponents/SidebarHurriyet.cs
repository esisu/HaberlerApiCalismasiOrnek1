...
namespace HaberlerApiCalismasiOrnek1.ViewComponents
{
    public class SidebarHurriyet : ViewComponent
    {
        ...
        {
            List<HaberContent> haberContents = _connectDb.HaberContent.FromSqlRaw("SELECT TOP 5 * FROM [Haberler].[dbo].[HaberContent] where Source='Hürriyet' ORDER BY Id DESC").ToList();
